...
```{r, eval = FALSE}
write.table(person_stratified_counts, file = paste(site_path, "/person_stratified_breakdown.csv", sep = ""))
```
...
```{r, eval = FALSE}
write.table(care_sites, file = paste(site_path, "/care_site_breakdown.csv", sep = ""))
```
...
```{r, eval = FALSE}
write.table(location, file = paste(site_path, "/location_breakdown.csv", sep = ""))
```
...
```{r, eval = FALSE}
write.table(visit_types, file = paste(site_path, "/visit_type_breakdown.csv", sep = ""))
```
