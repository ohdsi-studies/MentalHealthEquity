...
Open RStudio and navigate to the folder `MentalHealthEquity/study`.
Within that directory, do the following steps within the RStudio console: 

1. Load an RStudio project within the `MentalHealthEquity/study` folder or run `devtools::load_all()` to load the package
