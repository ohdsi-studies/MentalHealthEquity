# Baseline Characterization of [DISEASE]
TODO: Add in disease name for analysis

## Executive Summary

*Date:* 2022-11-02

*Summary:* Characterization to assess prevalence of [DISEASE] 
TODO: Add in disease name for analysis
...
TODO: Move the following lines to the set-up document
...
TODO: Write interpolation for the connection string here to pass along to the connectionString variable
```{r, eval = F}
...
TODO: Add code block for what SQL flavor to use (like :sqlite, :postgresql, and :redshift)
TODO: Swap "main" with the schema variable
```{r, eval = F}
...
TODO: Could you break this script into three different scripts for each disease? 

### Characterization Analysis and Queries

For this task, we want to load the concept set and get all of the concept IDs for each condition: bipolar disorder, depression, and suicidality.
